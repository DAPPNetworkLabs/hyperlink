  ...
  <card class="card-user">
    ...
    <div class="author">
      <a href="#">
        ...
        <h4 class="title">Some New DSP<br />
          <small>eosaccount12</small>          
        </h4>
      </a>
    </div>
    <p class="description text-center"> I am an early adopter of EdgeDSPs. please stake to me with caution.
    </p>
